...
public abstract class Hilt_AddMechanicFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AddMechanicFragment() {
    super();
  }

  Hilt_AddMechanicFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AddMechanicFragment_GeneratedInjector) this.generatedComponent()).injectAddMechanicFragment(UnsafeCasts.<AddMechanicFragment>unsafeCast(this));
    }
  }
