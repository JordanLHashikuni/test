...
public abstract class Hilt_JobListFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_JobListFragment() {
    super();
  }

  Hilt_JobListFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((JobListFragment_GeneratedInjector) this.generatedComponent()).injectJobListFragment(UnsafeCasts.<JobListFragment>unsafeCast(this));
    }
  }
