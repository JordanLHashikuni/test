...
public abstract class Hilt_JobDetailFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_JobDetailFragment() {
    super();
  }

  Hilt_JobDetailFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((JobDetailFragment_GeneratedInjector) this.generatedComponent()).injectJobDetailFragment(UnsafeCasts.<JobDetailFragment>unsafeCast(this));
    }
  }
